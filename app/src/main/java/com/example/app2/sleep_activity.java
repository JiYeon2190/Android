...
public class sleep_activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference imgReference = storageReference.child("surprise/");
                            ...
                            if (task.isSuccessful()) {
                                ...
                                iv.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        Intent intent = new Intent(getApplicationContext(), image4.class);
                                ...
                                iv.setOnLongClickListener(new View.OnLongClickListener() {
                                    ...
                                    public boolean onLongClick(View view) {
                                        ...
                                        AlertDialog.Builder alert = new AlertDialog.Builder(sleep_activity.this);
